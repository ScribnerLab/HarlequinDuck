...
params = data.frame(WNE, ENE, ARNE, BOTTN, ANCN, MIG, TDIV1to3, TDIV4to5, TDIV6, TDIV7, TDIV8, MIGSCAL, ANCRAT, GROWRATEE, GROWRATEW);
names(params) = parmnames;

write.table(params, paste0("SSR_", MODEL, ".def"), quote = FALSE, row.names = FALSE, col.names = TRUE);

DNAparams = data.frame(round(WNE*0.25), round(ENE*0.25), round(ARNE*0.25), round(BOTTN*0.25), round(ANCN*0.25), MIG*MIGSCAL, TDIV1to3, TDIV4to5, TDIV6, TDIV7, TDIV8, MIGSCAL, ANCRAT, GROWRATEE, GROWRATEW);
