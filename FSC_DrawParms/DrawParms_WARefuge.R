...
params = data.frame(WNE, ENE, BOTTN, ANCN, MIG, TDIV1to2, TDIV3to5, TDIV6, TDIV7, MIGSCAL, ANCRAT, GROWRATEE, GROWRATEW);
names(params) = parmnames;

write.table(params, paste0("SSR_", MODEL, ".def"), quote = FALSE, row.names = FALSE, col.names = TRUE);

DNAparams = data.frame(round(WNE*0.25), round(ENE*0.25), round(BOTTN*0.25), round(ANCN*0.25), MIG*MIGSCAL, TDIV1to2, TDIV3to5, TDIV6, TDIV7, MIGSCAL, ANCRAT, GROWRATEE, GROWRATEW);
